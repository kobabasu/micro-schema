...
<xsl:stylesheet
  ...
  <xsl:param name="project" select="'マスタ定義書'" />
  ...
  <fo:instream-foreign-object>
    ...
    <!-- svg start -->
      ...
      <text transform="matrix(1.0034 0 0 1 425.3 299.5)" class="st4 st5 st19 st7" text-anchor="middle"><xsl:value-of select="$project" /></text>
      </svg>
    <!-- svg end -->
